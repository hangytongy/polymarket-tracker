...
CATEGORIES = ['economy', 'world', 'politics', 'tech','pop-culture','climate-science']

for category in CATEGORIES:
    events_category = get_events(category)
    events_can_mm = get_mm_markets(events_category)
    if events_can_mm:
        events_can_mm = events_can_mm[:max_no_of_markets]
        all_events.extend(events_can_mm)
