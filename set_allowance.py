...
rpc_url = os.getenv("POLY_RPC_URL") # Polygon rpc url 
priv_key = os.getenv("POLY_PRIVATE_KEY") # Polygon account private key (needs some MATIC)
pub_key = os.getenv("POLY_PUBLIC_KEY") # Polygon account public key corresponding to private key
